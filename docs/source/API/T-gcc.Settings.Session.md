...
# Session
_namespace: [gcc.Settings](N-gcc.Settings.html)_
...
#### Finallize
```csharp
gcc.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
gcc.Settings.Session.FolkShoalThread(System.String,System.String)
```
