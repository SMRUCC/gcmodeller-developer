...
#### DESeq2
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.RTools.DESeq2.DESeq.DESeq2(System.Collections.Generic.IEnumerable{System.Collections.Generic.IEnumerable{System.String}},System.String)
```
HTSeq-Count
...
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.RTools.DESeq2.DESeq.FilterDifferentExpression(System.String,System.Double)
```
导出差异表达的基因

#### HTSeqCount
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.RTools.DESeq2.DESeq.HTSeqCount(System.String,System.String,System.Boolean)
```
...
#### Initialize
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.RTools.DESeq2.DESeq.Initialize(System.String)
```
...
#### summarizeOverlaps
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.RTools.DESeq2.DESeq.summarizeOverlaps(System.Collections.Generic.IEnumerable{System.String},System.String)
```
