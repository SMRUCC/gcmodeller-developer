...
# Session
_namespace: [Xfam.Settings](N-Xfam.Settings.html)_
...
#### Finallize
```csharp
Xfam.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
Xfam.Settings.Session.FolkShoalThread(System.String,System.String)
```
