...
#### #ctor
```csharp
OpenTK.Matrix4x2d.#ctor(System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double)
```
...
#### Add
```csharp
OpenTK.Matrix4x2d.Add(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix4x2d.CreateRotation(System.Double)
```
...
#### CreateScale
```csharp
OpenTK.Matrix4x2d.CreateScale(System.Double,System.Double)
```
...
#### Equals
```csharp
OpenTK.Matrix4x2d.Equals(OpenTK.Matrix4x2d)
```
...
#### Mult
```csharp
OpenTK.Matrix4x2d.Mult(OpenTK.Matrix4x2d,OpenTK.Matrix2x4d)
```
...
#### op_Addition
```csharp
OpenTK.Matrix4x2d.op_Addition(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
Matrix addition
...
_returns: A new Matrix4x2d which holds the result of the addition_

#### op_Equality
```csharp
OpenTK.Matrix4x2d.op_Equality(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix4x2d.op_Inequality(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix4x2d.op_Multiply(OpenTK.Matrix4x2d,OpenTK.Matrix2x4d)
```
...
#### op_Subtraction
```csharp
OpenTK.Matrix4x2d.op_Subtraction(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
Matrix subtraction
...
_returns: A new Matrix4x2d which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix4x2d.Subtract(OpenTK.Matrix4x2d,OpenTK.Matrix4x2d)
```
...
#### Transpose
```csharp
OpenTK.Matrix4x2d.Transpose(OpenTK.Matrix4x2d)
```
