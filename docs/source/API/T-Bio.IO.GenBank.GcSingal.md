...
#### #ctor
```csharp
Bio.IO.GenBank.GcSingal.#ctor(Bio.IO.GenBank.GcSingal)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other GCSingal instance.|


#### Clone
```csharp
Bio.IO.GenBank.GcSingal.Clone
```
Creates a new GCSingal that is a copy of the current GCSingal.
_returns: A new GCSingal that is a copy of this GCSingal._
