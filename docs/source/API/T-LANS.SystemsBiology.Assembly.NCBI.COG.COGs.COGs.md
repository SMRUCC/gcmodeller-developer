...
#### GroupRelease
```csharp
LANS.SystemsBiology.Assembly.NCBI.COG.COGs.COGs.GroupRelease(System.String)
```
将prot2003-2014.fasta按照@"P:LANS.SystemsBiology.Assembly.NCBI.COG.COGs.ProtFasta.GenomeName"分组导出，以方便使用bbh进行注释分析
...
#### SaveRelease
```csharp
LANS.SystemsBiology.Assembly.NCBI.COG.COGs.COGs.SaveRelease(System.String,System.String)
```
