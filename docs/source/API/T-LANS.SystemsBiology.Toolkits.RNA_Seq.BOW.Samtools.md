...
#### Assembly
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Assembly(LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.DocumentFormat.SAM.SAM,System.Boolean,System.String)
```
...
#### Bam2Sam
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Bam2Sam(System.String,System.String)
```
...
#### Import
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Import(System.String,System.String,System.String)
```
Next, we need to convert the SAM file into a BAM file. (A BAM file is just a binary version of a SAM file.)

#### Index
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Index(System.String,System.String)
```
...
#### Indexing
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Indexing(System.String)
```
...
#### Sam2Bam
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Sam2Bam(System.String,System.String)
```
...
#### Sort
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Sort(System.String,System.String,System.Boolean)
```
...
#### Viewing
```csharp
LANS.SystemsBiology.Toolkits.RNA_Seq.BOW.Samtools.Viewing(System.String,System.String)
```
