...
```csharp
LANS.SystemsBiology.GCModeller.Framework.Kernel_Driver.KernelDriver`3.__invokeDataAcquisition
```
数据采集程序的驱动句柄

#### LoadEngineKernel
```csharp
LANS.SystemsBiology.GCModeller.Framework.Kernel_Driver.KernelDriver`3.LoadEngineKernel(`2)
```
...
#### Run
```csharp
LANS.SystemsBiology.GCModeller.Framework.Kernel_Driver.KernelDriver`3.Run
```
