...
=== Palindromic hexamers ===
 ...
 @"M:LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.SearchMirror(LANS.SystemsBiology.SequenceModel.I_PolymerSequenceModel,System.Int32,System.Int32)" (镜像回文序列)
 ...
 @"M:LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.SimilarityMatches.Repeats.InvokeSearchReversed(System.String,System.Int32,System.Int32,System.Double)" (反向重复)
 ...
 @"T:LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Imperfect" (非完全回文)
 ...
 -- van Noort V, Worning P, Ussery DW, Rosche WA, Sinden RR Strand misalignments lead To 
 quasipalindrome correction (2003) 19:365-9
 @"M:LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.SearchPalindrome(LANS.SystemsBiology.SequenceModel.I_PolymerSequenceModel,System.Int32,System.Int32)" (简单回文)
 ...
 -- L. J. Jensen And C. Friis And D.W. Ussery Three views of complete chromosomes (1999) 150773-777
 @"M:LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.RepeatsSearchAPI.SearchRepeats(LANS.SystemsBiology.SequenceModel.I_PolymerSequenceModel,System.Int32,System.Int32,System.Int32)" (简单重复序列)
...
#### CreateMirrors
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.CreateMirrors(System.String,System.String)
```
这个函数求解的是绝对相等的
...
#### HaveMirror
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.HaveMirror(System.String,System.String)
```
Have mirror repeats?
...
#### HavePalindrome
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.HavePalindrome(System.String,System.String)
```
...
#### SearchMirror
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.Topologically.Palindrome.SearchMirror(LANS.SystemsBiology.SequenceModel.I_PolymerSequenceModel,System.Int32,System.Int32)
```
搜索序列上面的镜像回文片段
