...
#### #ctor
```csharp
Bio.IO.GenBank.MiscStructure.#ctor(Bio.IO.GenBank.MiscStructure)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other MiscStructure instance.|


#### Clone
```csharp
Bio.IO.GenBank.MiscStructure.Clone
```
Creates a new MiscStructure that is a copy of the current MiscStructure.
_returns: A new MiscStructure that is a copy of this MiscStructure._
