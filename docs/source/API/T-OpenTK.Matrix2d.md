...
#### #ctor
```csharp
OpenTK.Matrix2d.#ctor(System.Double,System.Double,System.Double,System.Double)
```
...
#### Add
```csharp
OpenTK.Matrix2d.Add(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix2d.CreateRotation(System.Double)
```
...
_returns: The resulting Matrix2d instance._

#### CreateScale
```csharp
OpenTK.Matrix2d.CreateScale(System.Double,System.Double)
```
...
#### Equals
```csharp
OpenTK.Matrix2d.Equals(OpenTK.Matrix2d)
```
...
#### Invert
```csharp
OpenTK.Matrix2d.Invert(OpenTK.Matrix2d)
```
...
#### Mult
```csharp
OpenTK.Matrix2d.Mult(OpenTK.Matrix2d,OpenTK.Matrix2x4d)
```
...
#### op_Addition
```csharp
OpenTK.Matrix2d.op_Addition(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
Matrix addition
...
#### op_Equality
```csharp
OpenTK.Matrix2d.op_Equality(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix2d.op_Inequality(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix2d.op_Multiply(OpenTK.Matrix2d,OpenTK.Matrix2x4d)
```
...
#### op_Subtraction
```csharp
OpenTK.Matrix2d.op_Subtraction(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
Matrix subtraction
...
_returns: A new Matrix2d which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix2d.Subtract(OpenTK.Matrix2d,OpenTK.Matrix2d)
```
...
#### Transpose
```csharp
OpenTK.Matrix2d.Transpose(OpenTK.Matrix2d)
```
