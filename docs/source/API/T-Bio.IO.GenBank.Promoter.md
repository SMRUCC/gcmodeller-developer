...
#### #ctor
```csharp
Bio.IO.GenBank.Promoter.#ctor(Bio.IO.GenBank.Promoter)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other Promoter instance.|


#### Clone
```csharp
Bio.IO.GenBank.Promoter.Clone
```
Creates a new Promoter that is a copy of the current Promoter.
_returns: A new Promoter that is a copy of this Promoter._
