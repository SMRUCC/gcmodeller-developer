...
#### #ctor
```csharp
OpenTK.Matrix2x3.#ctor(System.Single,System.Single,System.Single,System.Single,System.Single,System.Single)
```
...
#### Add
```csharp
OpenTK.Matrix2x3.Add(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix2x3.CreateRotation(System.Single)
```
...
#### CreateScale
```csharp
OpenTK.Matrix2x3.CreateScale(System.Single,System.Single)
```
...
#### Equals
```csharp
OpenTK.Matrix2x3.Equals(OpenTK.Matrix2x3)
```
...
#### Mult
```csharp
OpenTK.Matrix2x3.Mult(OpenTK.Matrix2x3,OpenTK.Matrix3x4)
```
...
#### op_Addition
```csharp
OpenTK.Matrix2x3.op_Addition(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
Matrix addition
...
_returns: A new Matrix2x3 which holds the result of the addition_

#### op_Equality
```csharp
OpenTK.Matrix2x3.op_Equality(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix2x3.op_Inequality(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix2x3.op_Multiply(OpenTK.Matrix2x3,OpenTK.Matrix3x4)
```
...
#### op_Subtraction
```csharp
OpenTK.Matrix2x3.op_Subtraction(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
Matrix subtraction
...
_returns: A new Matrix2x3 which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix2x3.Subtract(OpenTK.Matrix2x3,OpenTK.Matrix2x3)
```
...
#### Transpose
```csharp
OpenTK.Matrix2x3.Transpose(OpenTK.Matrix2x3)
```
