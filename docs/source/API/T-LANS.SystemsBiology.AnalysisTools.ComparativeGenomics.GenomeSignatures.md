...
#### __counts
```csharp
LANS.SystemsBiology.AnalysisTools.ComparativeGenomics.GenomeSignatures.__counts(LANS.SystemsBiology.SequenceModel.NucleotideModels.NucleicAcid,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA[])
```
...
#### __counts_p
```csharp
LANS.SystemsBiology.AnalysisTools.ComparativeGenomics.GenomeSignatures.__counts_p(LANS.SystemsBiology.SequenceModel.NucleotideModels.NucleicAcid,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA[])
```
...
#### CodonSignature
```csharp
LANS.SystemsBiology.AnalysisTools.ComparativeGenomics.GenomeSignatures.CodonSignature(LANS.SystemsBiology.SequenceModel.NucleotideModels.NucleicAcid,LANS.SystemsBiology.SequenceModel.NucleotideModels.Translation.Codon)
```
CODON SIGNATURE
...
#### DinucleotideBIAS
```csharp
LANS.SystemsBiology.AnalysisTools.ComparativeGenomics.GenomeSignatures.DinucleotideBIAS(LANS.SystemsBiology.SequenceModel.NucleotideModels.NucleicAcid,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA)
```
...
#### DinucleotideBIAS_p
```csharp
LANS.SystemsBiology.AnalysisTools.ComparativeGenomics.GenomeSignatures.DinucleotideBIAS_p(LANS.SystemsBiology.SequenceModel.NucleotideModels.NucleicAcid,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA,LANS.SystemsBiology.SequenceModel.NucleotideModels.DNA)
```
Dinucleotide relative abundance values (dinucleotide bias) are assessed through the odds ratio p(XY) = f(XY)/f(X)f(Y), 
