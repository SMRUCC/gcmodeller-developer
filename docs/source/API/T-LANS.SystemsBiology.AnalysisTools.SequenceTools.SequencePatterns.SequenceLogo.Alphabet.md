...
#### CompareTo
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.SequenceLogo.Alphabet.CompareTo(System.Object)
```
...
#### Height
```csharp
LANS.SystemsBiology.AnalysisTools.SequenceTools.SequencePatterns.SequenceLogo.Alphabet.Height(System.Double)
```
