...
#### #ctor
```csharp
OpenTK.Matrix2.#ctor(System.Single,System.Single,System.Single,System.Single)
```
...
#### Add
```csharp
OpenTK.Matrix2.Add(OpenTK.Matrix2,OpenTK.Matrix2)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix2.CreateRotation(System.Single)
```
...
_returns: The resulting Matrix2 instance._

#### CreateScale
```csharp
OpenTK.Matrix2.CreateScale(System.Single,System.Single)
```
...
#### Equals
```csharp
OpenTK.Matrix2.Equals(OpenTK.Matrix2)
```
...
#### Invert
```csharp
OpenTK.Matrix2.Invert(OpenTK.Matrix2)
```
...
#### Mult
```csharp
OpenTK.Matrix2.Mult(OpenTK.Matrix2,OpenTK.Matrix2x4)
```
...
#### op_Addition
```csharp
OpenTK.Matrix2.op_Addition(OpenTK.Matrix2,OpenTK.Matrix2)
```
Matrix addition
...
#### op_Equality
```csharp
OpenTK.Matrix2.op_Equality(OpenTK.Matrix2,OpenTK.Matrix2)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix2.op_Inequality(OpenTK.Matrix2,OpenTK.Matrix2)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix2.op_Multiply(OpenTK.Matrix2,OpenTK.Matrix2x4)
```
...
#### op_Subtraction
```csharp
OpenTK.Matrix2.op_Subtraction(OpenTK.Matrix2,OpenTK.Matrix2)
```
Matrix subtraction
...
_returns: A new Matrix2 which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix2.Subtract(OpenTK.Matrix2,OpenTK.Matrix2)
```
...
#### Transpose
```csharp
OpenTK.Matrix2.Transpose(OpenTK.Matrix2)
```
