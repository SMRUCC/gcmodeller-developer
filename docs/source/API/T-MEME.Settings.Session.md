...
# Session
_namespace: [MEME.Settings](N-MEME.Settings.html)_
...
#### Finallize
```csharp
MEME.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
MEME.Settings.Session.FolkShoalThread(System.String,System.String)
```
