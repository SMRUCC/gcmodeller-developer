...
#### Invoke
```csharp
LANS.SystemsBiology.SequenceModel.Polypeptides.SecondaryStructure.ChouFasmanRules.RuleBetaSheet.Invoke(LANS.SystemsBiology.SequenceModel.Polypeptides.SecondaryStructure.AminoAcid[])
```
Invoke calculation
