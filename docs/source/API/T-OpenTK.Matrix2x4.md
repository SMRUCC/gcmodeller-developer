...
#### #ctor
```csharp
OpenTK.Matrix2x4.#ctor(System.Single,System.Single,System.Single,System.Single,System.Single,System.Single,System.Single,System.Single)
```
...
#### Add
```csharp
OpenTK.Matrix2x4.Add(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix2x4.CreateRotation(System.Single)
```
...
_returns: The resulting Matrix2x3 instance._

#### CreateScale
```csharp
OpenTK.Matrix2x4.CreateScale(System.Single,System.Single)
```
...
#### Equals
```csharp
OpenTK.Matrix2x4.Equals(OpenTK.Matrix2x4)
```
...
#### Mult
```csharp
OpenTK.Matrix2x4.Mult(OpenTK.Matrix2x4,OpenTK.Matrix4)
```
...
#### op_Addition
```csharp
OpenTK.Matrix2x4.op_Addition(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
Matrix addition
...
_returns: A new Matrix2 which holds the result of the addition_

#### op_Equality
```csharp
OpenTK.Matrix2x4.op_Equality(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix2x4.op_Inequality(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix2x4.op_Multiply(OpenTK.Matrix2x4,OpenTK.Matrix4)
```
...
_returns: A new Matrix2x4 which holds the result of the multiplication_

#### op_Subtraction
```csharp
OpenTK.Matrix2x4.op_Subtraction(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
Matrix subtraction
...
_returns: A new Matrix2x4 which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix2x4.Subtract(OpenTK.Matrix2x4,OpenTK.Matrix2x4)
```
...
#### Transpose
```csharp
OpenTK.Matrix2x4.Transpose(OpenTK.Matrix2x4)
```
