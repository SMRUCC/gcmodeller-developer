...
#### #ctor
```csharp
Bio.IO.GenBank.MiscRna.#ctor(Bio.IO.GenBank.MiscRna)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other MiscRNA instance.|


#### Clone
```csharp
Bio.IO.GenBank.MiscRna.Clone
```
Creates a new MiscRNA that is a copy of the current MiscRNA.
_returns: A new MiscRNA that is a copy of this MiscRNA._
