...
#### #ctor
```csharp
OpenTK.Matrix3x2d.#ctor(System.Double,System.Double,System.Double,System.Double,System.Double,System.Double)
```
...
#### Add
```csharp
OpenTK.Matrix3x2d.Add(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
Adds two instances.
...
#### CreateRotation
```csharp
OpenTK.Matrix3x2d.CreateRotation(System.Double)
```
...
_returns: The resulting Matrix3x2d instance._

#### CreateScale
```csharp
OpenTK.Matrix3x2d.CreateScale(System.Double,System.Double)
```
...
#### Equals
```csharp
OpenTK.Matrix3x2d.Equals(OpenTK.Matrix3x2d)
```
...
#### Mult
```csharp
OpenTK.Matrix3x2d.Mult(OpenTK.Matrix3x2d,OpenTK.Matrix2x4d)
```
...
#### op_Addition
```csharp
OpenTK.Matrix3x2d.op_Addition(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
Matrix addition
...
_returns: A new Matrix3x2d which holds the result of the addition_

#### op_Equality
```csharp
OpenTK.Matrix3x2d.op_Equality(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix3x2d.op_Inequality(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix3x2d.op_Multiply(OpenTK.Matrix3x2d,OpenTK.Matrix2x4d)
```
...
#### op_Subtraction
```csharp
OpenTK.Matrix3x2d.op_Subtraction(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
Matrix subtraction
...
_returns: A new Matrix3x2d which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix3x2d.Subtract(OpenTK.Matrix3x2d,OpenTK.Matrix3x2d)
```
...
#### Transpose
```csharp
OpenTK.Matrix3x2d.Transpose(OpenTK.Matrix3x2d)
```
