...
```csharp
LANS.SystemsBiology.GCModeller.ModellingEngine.EngineSystem.ObjectModels.SubSystem.MetabolismCompartment.get_DataSerializerHandles
```
返回代谢物UniqueId列表，对于反应过程的数据则定义于DelegateSystem处

#### InitalizeTrimedHandles
```csharp
LANS.SystemsBiology.GCModeller.ModellingEngine.EngineSystem.ObjectModels.SubSystem.MetabolismCompartment.InitalizeTrimedHandles
```
