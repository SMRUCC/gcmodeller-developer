...
# Session
_namespace: [KEGG.Settings](N-KEGG.Settings.html)_
...
#### Finallize
```csharp
KEGG.Settings.Session.Finallize
```
Close the application session and save the settings file.

#### FolkShoalThread
```csharp
KEGG.Settings.Session.FolkShoalThread(System.String,System.String)
```
