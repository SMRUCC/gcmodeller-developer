...
#### #ctor
```csharp
Bio.IO.GenBank.MiscDifference.#ctor(Bio.IO.GenBank.MiscDifference)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other MiscDifference instance.|


#### Clone
```csharp
Bio.IO.GenBank.MiscDifference.Clone
```
Creates a new MiscDifference that is a copy of the current MiscDifference.
_returns: A new MiscDifference that is a copy of this MiscDifference._
