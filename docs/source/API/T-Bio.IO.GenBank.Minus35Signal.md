...
#### #ctor
```csharp
Bio.IO.GenBank.Minus35Signal.#ctor(Bio.IO.GenBank.Minus35Signal)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other Minus35Signal instance.|


#### Clone
```csharp
Bio.IO.GenBank.Minus35Signal.Clone
```
Creates a new Minus35Signal that is a copy of the current Minus35Signal.
_returns: A new Minus35Signal that is a copy of this Minus35Signal._
