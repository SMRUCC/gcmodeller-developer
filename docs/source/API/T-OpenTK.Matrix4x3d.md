...
#### #ctor
```csharp
OpenTK.Matrix4x3d.#ctor(System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double,System.Double)
```
...
#### Add
```csharp
OpenTK.Matrix4x3d.Add(OpenTK.Matrix4x3d@,OpenTK.Matrix4x3d@,OpenTK.Matrix4x3d@)
```
Adds two instances.
...
#### CreateFromAxisAngle
```csharp
OpenTK.Matrix4x3d.CreateFromAxisAngle(OpenTK.Vector3d,System.Double)
```
...
```csharp
OpenTK.Matrix4x3d.CreateFromQuaternion(OpenTK.Quaternion)
```
...
#### CreateRotationX
```csharp
OpenTK.Matrix4x3d.CreateRotationX(System.Double)
```
...
_returns: The resulting Matrix4dinstance._

#### CreateRotationY
```csharp
OpenTK.Matrix4x3d.CreateRotationY(System.Double)
```
...
#### CreateRotationZ
```csharp
OpenTK.Matrix4x3d.CreateRotationZ(System.Double)
```
...
#### CreateScale
```csharp
OpenTK.Matrix4x3d.CreateScale(System.Double,System.Double,System.Double)
```
...
#### CreateTranslation
```csharp
OpenTK.Matrix4x3d.CreateTranslation(OpenTK.Vector3d)
```
...
#### Equals
```csharp
OpenTK.Matrix4x3d.Equals(OpenTK.Matrix4x3d)
```
...
#### Invert
```csharp
OpenTK.Matrix4x3d.Invert(OpenTK.Matrix4x3d@,OpenTK.Matrix4x3d@)
```
...
#### Mult
```csharp
OpenTK.Matrix4x3d.Mult(OpenTK.Matrix4x3d@,System.Double,OpenTK.Matrix4x3d@)
```
...
#### op_Addition
```csharp
OpenTK.Matrix4x3d.op_Addition(OpenTK.Matrix4x3d,OpenTK.Matrix4x3d)
```
Matrix addition
...
_returns: A new Matrix4x3d which holds the result of the addition_

#### op_Equality
```csharp
OpenTK.Matrix4x3d.op_Equality(OpenTK.Matrix4x3d,OpenTK.Matrix4x3d)
```
...
#### op_Inequality
```csharp
OpenTK.Matrix4x3d.op_Inequality(OpenTK.Matrix4x3d,OpenTK.Matrix4x3d)
```
...
#### op_Multiply
```csharp
OpenTK.Matrix4x3d.op_Multiply(OpenTK.Matrix4x3d,System.Double)
```
...
_returns: A new Matrix4x3d which holds the result of the multiplication_

#### op_Subtraction
```csharp
OpenTK.Matrix4x3d.op_Subtraction(OpenTK.Matrix4x3d,OpenTK.Matrix4x3d)
```
Matrix subtraction
...
_returns: A new Matrix4x3d which holds the result of the subtraction_

#### Subtract
```csharp
OpenTK.Matrix4x3d.Subtract(OpenTK.Matrix4x3d@,OpenTK.Matrix4x3d@,OpenTK.Matrix4x3d@)
```
...
#### Transpose
```csharp
OpenTK.Matrix4x3d.Transpose(OpenTK.Matrix4x3d@,OpenTK.Matrix3x4d@)
```
