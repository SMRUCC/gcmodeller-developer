...
#### #ctor
```csharp
Bio.IO.GenBank.RibosomalRna.#ctor(Bio.IO.GenBank.RibosomalRna)
```
Private constructor for clone method.

|Parameter Name|Remarks|
|--------------|-------|
|other|Other RibosomalRNA instance.|


#### Clone
```csharp
Bio.IO.GenBank.RibosomalRna.Clone
```
Creates a new RibosomalRNA that is a copy of the current RibosomalRNA.
_returns: A new RibosomalRNA that is a copy of this RibosomalRNA._
