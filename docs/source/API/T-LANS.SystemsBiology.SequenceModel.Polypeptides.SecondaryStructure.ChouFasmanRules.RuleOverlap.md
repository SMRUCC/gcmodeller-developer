...
#### Invoke
```csharp
LANS.SystemsBiology.SequenceModel.Polypeptides.SecondaryStructure.ChouFasmanRules.RuleOverlap.Invoke(LANS.SystemsBiology.SequenceModel.Polypeptides.SecondaryStructure.AminoAcid[])
```
Invoke calculation
