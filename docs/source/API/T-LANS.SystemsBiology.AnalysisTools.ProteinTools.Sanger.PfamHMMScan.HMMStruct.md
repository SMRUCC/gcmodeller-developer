...
Symbol emission probabilities In the MATCH states.
 The format Is a matrix Of size @"P:LANS.SystemsBiology.AnalysisTools.ProteinTools.Sanger.PfamHMMScan.HMMStruct.ModelLength"-by-@"P:LANS.SystemsBiology.AnalysisTools.ProteinTools.Sanger.PfamHMMScan.HMMStruct.AlphaLength", where Each row corresponds To the emission distribution For a specific MATCH state.
#### MatchX
